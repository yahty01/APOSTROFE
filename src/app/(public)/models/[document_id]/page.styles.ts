...
export const modelDetailPageClasses = {
  ...
  galleryItem: 'relative aspect-[5/4] w-full overflow-hidden bg-[var(--color-paper)]',
  galleryItemSolo:
  ...
  detailsSection:
    'flex flex-col bg-[var(--color-surface)] px-5 py-7 md:px-8 md:py-10 lg:grid lg:h-full lg:grid-rows-[auto_auto_minmax(0,1fr)_auto] lg:overflow-hidden lg:px-6 lg:py-6 xl:px-8 xl:py-8',
  title:
    'max-w-[18ch] font-condensed text-[clamp(38px,4.6vw,72px)] leading-[0.88] uppercase tracking-[0.18em] [overflow-wrap:anywhere] lg:text-[clamp(30px,3.4vw,56px)]',
  meta:
    'mt-5 font-doc text-[11px] uppercase tracking-[0.2em] text-[var(--color-muted)] lg:mt-3 lg:text-[10px]',
  blocks:
    'mt-8 border-y border-[color:var(--color-line)] divide-y divide-[color:var(--color-line)] lg:mt-4 lg:min-h-0 lg:overflow-hidden',
  block: 'py-7 lg:py-4',
  blockTitle:
