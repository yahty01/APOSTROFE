...
export const topHeaderClasses = {
  ...
  nav: 'col-span-2 -mx-4 flex min-w-0 flex-nowrap items-center gap-2 overflow-x-auto px-4 pb-1 md:col-span-1 md:mx-0 md:justify-center md:px-0 md:pb-0 lg:overflow-visible',
  tab: 'ui-tab',
